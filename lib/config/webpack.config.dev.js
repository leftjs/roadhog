...
exports.default = function (config, cwd) {
  ...
  return {
    ...
    plugins: [new _webpack2.default.DefinePlugin({
      ...
      to: paths.appBuild
    }])).concat(!config.multipage ? [] : new _webpack2.default.optimize.CommonsChunkPlugin('common', 'common.js')).concat(!config.define ? [] : new _webpack2.default.DefinePlugin((0, _normalizeDefine2.default)(config.define))).concat(config.plugins || []),
